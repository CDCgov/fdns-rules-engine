...
public class DescriptionTest {
	...
	public void testExists() throws ValidatorException {
		InputStream object = getClass().getClassLoader().getResourceAsStream("junit/$description/objects/001.json");
		InputStream rules = getClass().getClassLoader().getResourceAsStream("junit/$description/rules/001.json");
		v.initialize(rules);
